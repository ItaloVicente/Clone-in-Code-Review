 ...
 * @generated
 */
public class SplitSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SplitPackageImpl.STACK_SASH_CONTAINER: {
				MStackSashContainer stackSashContainer = (MStackSashContainer)theEObject;
				T1 result = caseStackSashContainer(stackSashContainer);
				if (result == null) result = caseStackElement(stackSashContainer);
				if (result == null) result = casePartSashContainer(stackSashContainer);
				if (result == null) result = caseGenericTile(stackSashContainer);
				if (result == null) result = casePartSashContainerElement(stackSashContainer);
				if (result == null) result = caseWindowElement(stackSashContainer);
				if (result == null) result = caseApplicationElement(stackSashContainer);
				if (result == null) result = caseElementContainer(stackSashContainer);
				if (result == null) result = caseUIElement(stackSashContainer);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Stack Sash Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Stack Sash Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseStackSashContainer(MStackSashContainer object) {
		return null;
	}
