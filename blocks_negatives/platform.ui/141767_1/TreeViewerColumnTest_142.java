...
public class TreeSelectionTest extends TestCase {
	...
	private static void doTestEquals18(IElementComparer comparer) {
		EqualsHashCodeContractTestHelper.testExpectedEqualsObjects(new TreeSelection((TreePath) null, comparer),
	...
	private static void doTestEquals20(IElementComparer comparer) {
		EqualsHashCodeContractTestHelper.testExpectedEqualsObjects(new TreeSelection(
				newTreePaths(newTreePath("element 1", "element 2"), newTreePath("element 3", "element 4")), comparer),
