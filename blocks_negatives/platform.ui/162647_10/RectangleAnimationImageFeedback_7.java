...
public abstract class RectangleAnimationFeedbackBase extends AnimationFeedbackBase {
	...
	private List<Rectangle> startRects = new ArrayList<>();
	private List<Rectangle> endRects = new ArrayList<>();
	...
	public List<Rectangle> getStartRects() {
		return startRects;
	}

	public List<Rectangle> getEndRects() {
		return endRects;
	}

	public List<Rectangle> getCurrentRects(double amount) {
		List<Rectangle> currentRects = new ArrayList<>();
		Iterator<Rectangle> startIter = getStartRects().iterator();
		Iterator<Rectangle> endIter = getEndRects().iterator();
		while (startIter.hasNext()) {
			Rectangle start = startIter.next();
			Rectangle end = endIter.next();
