...
public class CollectionImpl extends Collection {
	...
	protected CollectionImpl(final String name, final long cid, final Scope scope, final Bucket bucket) {
		...
		this.reactiveCollection.withMutationOptions(this.mutationOptions);
	}
	...
	@Override
	public <D extends Document<?>> D insert(D document, MutationOptions options, long timeout, TimeUnit timeunit) {
		return Blocking.blockForSingle(this.reactiveCollection.insert(document, options, timeout, timeunit), timeout, timeunit);
	}

	@Override
	public <D extends Document<?>> D upsert(D document, MutationOptions options, long timeout, TimeUnit timeunit) {
		return Blocking.blockForSingle(this.reactiveCollection.upsert(document, options, timeout, timeunit), timeout, timeunit);
	}

	@Override
	public <D extends Document<?>> D append(D document, MutationOptions options, long timeout, TimeUnit timeunit) {
		return Blocking.blockForSingle(this.reactiveCollection.append(document, options, timeout, timeunit), timeout, timeunit);
	}

	@Override
	public <D extends Document<?>> D prepend(D document, MutationOptions options, long timeout, TimeUnit timeunit) {
		return Blocking.blockForSingle(this.reactiveCollection.prepend(document, options, timeout, timeunit), timeout, timeunit);
	}

	@Override
	public <D extends Document<?>> D replace(D document, MutationOptions options, long timeout, TimeUnit timeunit) {
		return Blocking.blockForSingle(this.reactiveCollection.replace(document, options, timeout, timeunit), timeout, timeunit);
	}

	@Override
	public JsonLongDocument counter(String id, long delta, long initial, MutationOptions options, long timeout, TimeUnit timeunit) {
	...
	@Override
	public <D extends Document<?>> D remove(String id, Class<D> target, MutationOptions options, long timeout, TimeUnit timeunit) {
		return Blocking.blockForSingle(this.reactiveCollection.remove(id, target, timeout, timeunit), timeout, timeunit);
	}

	@Override
	public <D extends Document<?>> D remove(D document, MutationOptions options, long timeout, TimeUnit timeunit) {
