  ...
  public void testUTF8KeyDelete() throws Exception {
    final String key =
        "junit.ÐÐ´ÑÐ°Ð²ÑÑÐ²ÑÐ¹ÑÐµ." + System.currentTimeMillis();
    final String value = "Skiing rocks if you can find the time to go!";
  ...
  public void testUTF8Value() throws Exception {
    ...
    final String value = "ÐÐ´ÑÐ°Ð²ÑÑÐ²ÑÐ¹ÑÐµ ÐÐ´ÑÐ°Ð²ÑÑÐ²ÑÐ¹ÑÐµ Ð"
        + "Ð´ÑÐ°Ð²ÑÑÐ²ÑÐ¹ÑÐµ Skiing rocks if you can find the time "
        + "to go!";
