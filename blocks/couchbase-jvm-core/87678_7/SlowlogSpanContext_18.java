...
public class SlowlogSpanBuilder implements Tracer.SpanBuilder {
    ...
    public SlowlogSpanBuilder(SlowlogTracer tracer, String operationName, ScopeManager scopeManager) {
        this.tracer = tracer;
