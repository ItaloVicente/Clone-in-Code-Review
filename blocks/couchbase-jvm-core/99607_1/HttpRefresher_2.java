    ...
    private Observable<String> buildRefreshFallbackSequence(final List<NodeInfo> nodeInfos,
    ...
    private Observable<String> refreshAgainstNode(final String bucketName,
        ...
        return Observable.defer(new Func0<Observable<BucketConfigResponse>>() {
            ...
            @Override
            public String call(final BucketConfigResponse response) {
                return response.config().replace("$HOST", hostname.address());
            }
