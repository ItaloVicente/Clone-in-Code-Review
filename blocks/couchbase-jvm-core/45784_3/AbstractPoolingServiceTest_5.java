...
public class AbstractPoolingServiceTest {
    ...
    public void shouldConnectNumberOfEndpoints() {
        ...
        int endpoints = 2;
        InstrumendetService service = new InstrumendetService(host, bucket, password, port, env, endpoints,
    ...
    class InstrumendetService extends AbstractPoolingService {

        public InstrumendetService(String hostname, String bucket, String password, int port, CoreEnvironment env,
