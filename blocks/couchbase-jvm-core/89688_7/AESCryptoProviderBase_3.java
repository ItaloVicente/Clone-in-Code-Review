...
public class AESCryptoProviderBase implements CrytoProvider {
    ...
    public byte[] encrypt(byte[] data) throws Exception {
        ...
        byte[] encrypted = cipher.doFinal(new String(data, Charset.forName("UTF-8")).getBytes());
    ...
    private void checkKeySize(SecretKeySpec key) throws Exception {
        ...
        if (keySize != this.keySize) {
            throw new Exception("Invalid key size " + keySize + " for AES256 Algorithm");
        }
    }
}
