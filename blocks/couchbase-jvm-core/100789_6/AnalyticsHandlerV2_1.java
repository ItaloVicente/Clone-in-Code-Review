...
public class AnalyticsHandlerV2 extends AbstractGenericHandler<HttpObject, HttpRequest, AnalyticsRequest>{
    ...
    protected HttpRequest encodeRequest(final ChannelHandlerContext ctx, final AnalyticsRequest msg) throws Exception {
        ...
        if (msg instanceof GenericAnalyticsRequest) {
            ...
            query.release();
        } else if (msg instanceof AnalyticsQueryStatusRequest) {
            AnalyticsQueryStatusRequest statusRequest = (AnalyticsQueryStatusRequest) msg;
            request = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, statusRequest.path());
        } else if (msg instanceof AnalyticsQueryResultRequest) {
            AnalyticsQueryResultRequest resultRequest = (AnalyticsQueryResultRequest) msg;
            request = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, resultRequest.path());
