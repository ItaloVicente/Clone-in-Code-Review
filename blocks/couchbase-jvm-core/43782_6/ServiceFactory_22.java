...
import com.couchbase.client.core.service.strategies.DirectSelectionStrategy;
import com.couchbase.client.core.service.strategies.SelectionStrategy;
import com.lmax.disruptor.RingBuffer;

public class DCPService extends AbstractService {
    private static final SelectionStrategy STRATEGY = new DirectSelectionStrategy();
    ...
    public DCPService(String hostname, String bucket, String password, int port, CoreEnvironment env, RingBuffer<ResponseEvent> responseBuffer) {
        super(hostname, bucket, password, port, env, env.dcpEndpoints(), STRATEGY, responseBuffer, FACTORY);
    }
