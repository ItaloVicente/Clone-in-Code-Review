    ...
    private void handleDCPRequest(ChannelHandlerContext ctx, FullBinaryMemcacheResponse msg) {
        ...
        switch (msg.getOpcode()) {
            case OP_SNAPSHOT_MARKER:
                ...
                request = new SnapshotMarkerRequest(msg.getStatus(), startSequenceNumber, endSequenceNumber,
                        flags, stream.bucket());
                break;
            ...
            case OP_MUTATION:
                ...
                request = new MutationRequest(msg.getStatus(), msg.getKey(), msg.content().retain(),
