...
public class SlowOperationSpan implements Span, Comparable<SlowOperationSpan> {

    private final SlowOperationTracer tracer;
    private final SlowOperationSpanContext spanContext;
    private final Map<String, Object> tags;
    private List<SlowOperationLogData> logs;
    private String operationName;
    private AtomicBoolean finished;
    private long durationMicroseconds;
    private final long startTimeMicroseconds;

    public SlowOperationSpan(SlowOperationTracer tracer, SlowOperationSpanContext spanContext, Map<String, Object> tags,
    ...
    @Override
    public SlowOperationSpanContext context() {
        return spanContext;
    }
    ...
    public synchronized Object getTag(final String key) {
        return tags.get(key);
    }
    ...
    public  Span log(long timestampMicroseconds, Map<String, ?> fields) {
        ...
        synchronized (this) {
            if (logs == null) {
                this.logs = new ArrayList<SlowOperationLogData>();
            }
            logs.add(new SlowOperationLogData(timestampMicroseconds, null, fields));
        }
        return this;
    }
    ...
    public Span log(long timestampMicroseconds, String event) {
        ...
        synchronized (this) {
            ...
            logs.add(new SlowOperationLogData(timestampMicroseconds, event, null));
        }
        return this;
    }
    ...
    @Override
    public int compareTo(final SlowOperationSpan o) {
        return ((Long) durationMicroseconds).compareTo(o.duration()) ;
    }
