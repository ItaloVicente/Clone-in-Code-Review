...
public class SubDictUpsertRequest extends AbstractSubdocMutationRequest {
    ...
    public SubDictUpsertRequest(String key, String path, ByteBuf fragment, String bucket, int expiration, int flags) {
        this(key, path, bucket, expiration, fragment, flags);
    }

    public SubDictUpsertRequest(String key, String path, ByteBuf fragment, String bucket, int expiration) {
    ...
    public SubDictUpsertRequest(String key, String path, String bucket, int expiration, ByteBuf fragment, int flags) {
