...
public class ShaSaslClient implements SaslClient {
    ...
    private String client_final_message_no_proof;
    ...
    public byte[] evaluateChallenge(byte[] challenge) throws SaslException {
        if (client_first_message == null) {
            ...
            client_first_message = "n,,n=" + getUserName() + ",r=" + clientNonce;
            ...
            client_final_message_no_proof = "c=biws,r=" + nonce;
            String client_final_message = client_final_message_no_proof + ",p=" + Base64.encode(getClientProof());
    ...
    private String getAuthMessage() {
        ...
        if (client_final_message_no_proof == null) {
            throw new RuntimeException("can't call getAuthMessage without client_final_message_no_proof is set");
        }
        return client_first_message_bare + "," + server_first_message + "," + client_final_message_no_proof;
    }
}
