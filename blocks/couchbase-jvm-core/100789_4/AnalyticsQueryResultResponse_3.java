...
public class AnalyticsQueryResultRequest extends AbstractCouchbaseRequest implements AnalyticsRequest, PrelocatedRequest {
    ...
    public AnalyticsQueryResultRequest(String statusPath, String bucket, String username, String password) {
        this(statusPath, bucket, username, password, null);
    }

    public AnalyticsQueryResultRequest(String statusPath, String bucket, String username, String password, InetAddress target) {
