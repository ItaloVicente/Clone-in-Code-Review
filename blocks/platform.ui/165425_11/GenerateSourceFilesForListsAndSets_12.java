...
import org.eclipse.core.internal.databinding.bind.SetOneWayStepsImps.OneWaySetConvertToStepImpl;
...
class CommonStepsImpl {
	static final class OneWayDirectionAndFromStepImpl //
		...
		@Override
		public <F> OneWayValueConvertStep<F, F, ?> from(IObservableValue<F> from) {
			builder.doFromStep(from, false);
			return new OneWayValueConvertToStepImpl<>(builder);
		}

		@Override
		public <F> OneWayListConvertStep<F, F, ?> from(IObservableList<F> from) {
			builder.doFromStep(from, false);
			return new OneWayListConvertToStepImpl<>(builder);
		}

		@Override
		public <F> OneWaySetConvertStep<F, F, ?> from(IObservableSet<F> from) {
			builder.doFromStep(from, false);
