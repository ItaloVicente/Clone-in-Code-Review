...
public class TestUnitShellFactory extends AbstractFactoryTest {
	...
	public void addsShellActivatedListener() {
		...
		Shell myShell = ShellFactory.createShell(SWT.BORDER).onActivate(e -> raisedEvents[0] = e).create(shell);
	...
	public void addsShellDeactivatedListener() {
		final ShellEvent[] raisedEvents = new ShellEvent[1];
		Shell myShell = ShellFactory.createShell(SWT.BORDER).onDeactivate(e -> raisedEvents[0] = e).create(shell);
	...
	public void addsShellIconfiedListener() {
		final ShellEvent[] raisedEvents = new ShellEvent[1];
		Shell myShell = ShellFactory.createShell(SWT.BORDER).onIconify(e -> raisedEvents[0] = e).create(shell);
	...
	public void addsShellDeiconfiedListener() {
		final ShellEvent[] raisedEvents = new ShellEvent[1];
		Shell myShell = ShellFactory.createShell(SWT.BORDER).onDeiconify(e -> raisedEvents[0] = e).create(shell);
	...
	public void addsShellClosedListener() {
		final ShellEvent[] raisedEvents = new ShellEvent[1];
		Shell myShell = ShellFactory.createShell(SWT.BORDER).onClose(e -> raisedEvents[0] = e).create(shell);
