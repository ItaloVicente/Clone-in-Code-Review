...
public class LargeDocumentPreferenceHandler {
	...
	private static final String DISABLED_EXTENSIONS_PREFERENCE = IPreferenceConstants.LARGE_DOCUMENT_EDITOR_FOR_EXTENSIONS
			+ "_disabled"; //$NON-NLS-1$
	private static final String CONFIGURED_EXTENSIONS_PREFERENCE = IPreferenceConstants.LARGE_DOCUMENT_EDITOR_FOR_EXTENSIONS
			+ "_types"; //$NON-NLS-1$
	private static final String DEFAULT_PREFERENCE_NAME = IPreferenceConstants.LARGE_DOCUMENT_EDITOR_FOR_EXTENSIONS
			+ "_DEFAULT"; //$NON-NLS-1$
	...
	public static String getDefaultPreferenceValues() {
		String documentSize = PREFERENCE_STORE.getString(DEFAULT_PREFERENCE_NAME);
		return documentSize;
	}

	public static void removeDefaultPreference() {
		setDefaultPreferenceValue(null);
	}

	public static void setDefaultPreferenceValue(String documentSize) {
		PREFERENCE_STORE.setValue(DEFAULT_PREFERENCE_NAME, documentSize);
	}
	...
	Optional<String> getEditorForInput(IEditorInput editorInput) {
		if (editorInput instanceof IPathEditorInput) {
			...
			boolean largeDocument = isLargeDocumentFromLegacy(pathEditorInput);
