...
public class DelegatingSelectionListenerAction extends BaseSelectionListenerAction {
	...
	private IPropertyChangeListener propertyChangeListener = this::firePropertyChange;
	...
	protected boolean updateSelection(IStructuredSelection selection) {
		for (BaseSelectionListenerAction action : possibleDelegates) {
			if (chosenDelegate == action) {
				...
				IPropertyChangeListener accumulator = events::add;
				...
				if (action.isEnabled()) {
					...
					events.forEach(this::firePropertyChange);
