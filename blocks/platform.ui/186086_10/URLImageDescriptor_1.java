...
public class LazyResourceManager extends ResourceManager {
	...
	public Object create(DeviceResourceDescriptor descriptor) {
		leastRecentlyUsed.get(descriptor); // update least recently used;
		Object cached = parent.find(descriptor);
		if (cached != null) {
			return cached;
		}
	...
	protected boolean shouldBeCached(DeviceResourceDescriptor descriptor) {
