...
public final class ButtonFactory extends ControlFactory<ButtonFactory, Button> {
	...
	public static ButtonFactory newButton(int style, String text) {
		return new ButtonFactory(style).text(text);
	}

	public static ButtonFactory newButton(int style, Image image) {
		return new ButtonFactory(style).image(image);
	}
