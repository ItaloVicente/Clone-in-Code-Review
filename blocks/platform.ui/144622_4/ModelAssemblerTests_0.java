	...
	public void testNotExistsNonInitialFragmentPartlyMerge() throws IOException {
		...
		EObject eCommandOpen = (EObject) commandOpen;
		E4XMIResource rCommandOpen = (E4XMIResource) eCommandOpen.eResource();
		rCommandOpen.setID(eCommandOpen, "_YlobgZQUEem9FqSgVrNMpA");

		EObject eHandlerOpen = (EObject) handlerOpen;
		E4XMIResource rHandlerOpen = (E4XMIResource) eHandlerOpen.eResource();
		rHandlerOpen.setID(eHandlerOpen, "_b7xQ4ZQUEem9FqSgVrNMpA");
		...
		MHandledToolItem mToolItem = foundElements.get(0);
		assertThat(mToolItem.getCommand().getElementId(), equalTo(commandOpen.getElementId()));
		assertThat(mToolItem.getElementId(), equalTo("handledtoolitem.open"));
	}
