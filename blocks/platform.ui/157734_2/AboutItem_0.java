...
public class AboutDialogE4 extends TrayDialog {
	...
	private final int MAX_IMAGE_WIDTH_FOR_TEXT = 250;
	...
	protected Control createDialogArea(final Composite parent) {
		...
		int topContainerHeightHint = calculateTopContainerHeight(aboutImage, background, foreground, topContainer,
				parent);
	...
	private int calculateTopContainerHeight(Image aboutImage, Color background, Color foreground,
