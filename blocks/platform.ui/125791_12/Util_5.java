...
public class RegistryWriter implements IRegistryWriter {
	...
	public RegistryWriter(IWinRegistry winRegistry, IFileProvider fileProvider) {
		URI homeLocURI = filePathToURI(System.getProperty("eclipse.home.location")); //$NON-NLS-1$
		this.winRegistry = winRegistry;
		this.fileProvider = fileProvider;
		setLauncherPath(getLauncher(System.getProperty("eclipse.launcher"), homeLocURI)); //$NON-NLS-1$
	}
