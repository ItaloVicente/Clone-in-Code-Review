...
public class UrlHandlerPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private void createColumns(TableViewer viewer) {
		...
		linkNameCol.getColumn().setText("Scheme Name"); //$NON-NLS-1$
		...
		linkLocationNameCol.getColumn().setText("Scheme Description"); //$NON-NLS-1$
	...
	private Collection<ISchemeInformation> getAllSchemesFromExtensionPoints() {
		...
		for (IConfigurationElement element : elements) {
			...
			ISchemeInformation schemeInformation = ISchemeInformation.getInstance(schemeName, "Description", ""); //$NON-NLS-1$ //$NON-NLS-2$
