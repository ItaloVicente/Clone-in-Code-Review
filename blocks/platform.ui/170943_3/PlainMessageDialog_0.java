...
public class PlainMessageDialog extends IconAndMessageDialog {
	...
	public static class Builder {
		...
		private List<String> buttonLabels = List.of(IDialogConstants.OK_LABEL);
		private int defaultButtonIndex = 0;

		public Builder(Shell shell, String dialogTitle) {
			this.shell = shell;
			this.dialogTitle = dialogTitle;
		}

		public Builder titleImage(Image titleImage) {
