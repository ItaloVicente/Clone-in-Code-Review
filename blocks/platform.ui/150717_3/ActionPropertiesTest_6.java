...
public class StateProperty<T> extends SimpleValueProperty<IObjectWithState, T> {
	...
	@Override
	protected void doSetValue(IObjectWithState source, T value) {
	...
	@Override
	public INativePropertyListener<IObjectWithState> adaptListener(
			ISimplePropertyListener<IObjectWithState, ValueDiff<? extends T>> listener) {
		class Listener implements INativePropertyListener<IObjectWithState>, IStateListener {
			@Override
