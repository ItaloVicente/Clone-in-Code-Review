...
public final class CommonSteps {
	...
	public interface OneWayFromStep extends FromStep {
		@Override
		<F> OneWayValueConvertStep<F, F, ?> from(IObservableValue<F> from);

		@Override
		<F> OneWayListConvertStep<F, F, ?> from(IObservableList<F> from);

		@Override
		<F> OneWaySetConvertStep<F, F, ?> from(IObservableSet<F> from);
	}
