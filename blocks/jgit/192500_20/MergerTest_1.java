...
public class MergerRenameTest extends RepositoryTestCase {
  ...
  @Theory
  public void checkRenameModify_dirtyWorkingTree_renameInTheirs_fail(MergeStrategy strategy
      throws Exception {
    if(!dirtyOriginal && !dirtyRename){
      return;
    }
  ...
  @Theory
  public void checkSourceAddedOnRenameSide_dirtyWorkTree_failed(MergeStrategy strategy
    Git git = Git.wrap(db);
    String originalContent = "a\nb\nc";
    String slightlyModifiedContent = "a\nb\nb";
    String originalFilename = "file2";
  ...
  @Theory
  public void checkSourceAddedOnRenameSide_dirtyIndex_failed(MergeStrategy strategy
    Git git = Git.wrap(db);
    String originalContent = "a\nb\nc";
    String slightlyModifiedContent = "a\nb\nb";
    String originalFilename = "file2";
  ...
  @Theory
  public void checkRenameDir_allFilesMoved_someFilesAddedOnRenameSide(MergeStrategy strategy
    String originalContent = "a\nb\nc";
    String slightlyModifiedContent = "a\nb\nb";
    Map<String
    for (Entry<String
  ...
  @Theory
  public void checkRenameDir_allFilesMoved_someFilesAddedOnModifySide(MergeStrategy strategy
    String originalContent = "a\nb\nc";
    String slightlyModifiedContent = "a\nb\nb";
    Map<String
    for (Entry<String
  ...
  @Theory
  public void checkRenameDir_allFilesMoved_someFilesAddedOnBothSides(MergeStrategy strategy
    String originalContent = "a\nb\nc";
    String slightlyModifiedContent = "a\nb\nb";
    Map<String
    for (Entry<String
