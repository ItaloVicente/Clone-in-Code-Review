...
public class BinaryPatchRoundTripTest
{
    ...
    {
        File patchFile = new File(testDir
        File repoDir = new File(testDir
        repoDir.mkdirs();
        File deployDir = new File(testDir
        deployDir.mkdirs();
        ...
        File generatedFie = new File(deployDir

        Assert.assertTrue(generatedFie.exists());
        Assert.assertArrayEquals(Files.readAllBytes(getResourceFileByName("Git-logo.bmp").toPath())
    }
    ...
    public void testDeltaBinaryPatch() throws Exception
    {
        ...
        Files.copy(modifiedTestFile.toPath()
        ...
        Assert.assertTrue(generatedFie.exists());
        Assert.assertArrayEquals(Files.readAllBytes(getResourceFileByName("Modified-Git-logo.bmp").toPath())
    }
