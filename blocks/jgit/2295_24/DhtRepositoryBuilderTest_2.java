...
public class DhtPackParserTest {
	...
	public void testLargeFragmentWithRefDelta() throws IOException {
		...
		DhtRepository repo = (DhtRepository) new DhtRepositoryBuilder<DhtRepositoryBuilder
				.build();
		repo.create(true);
	...
	private void writeOffset(TemporaryBuffer.Heap pack
			throws IOException {
	...
	private void store(TemporaryBuffer.Heap pack
			throws IOException {
