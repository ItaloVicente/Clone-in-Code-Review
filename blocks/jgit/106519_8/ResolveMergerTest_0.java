	...
	public void checkContentMergeLargeBinaries(MergeStrategy strategy) throws Exception {
		...
		byte[] base = Arrays.copyOf(binary
		writeTrashFile("file"
		...
		binary[idx] = '@';
		writeTrashFile("file"
		byte[] editBlob1 = Arrays.copyOf(binary
	...
	class BigReadForbiddenInserter extends ObjectInserter.Filter {
		...
		BigReadForbiddenInserter(ObjectInserter delegate
			this.delegate = delegate;
			this.forbidden = forbidden;
		}
