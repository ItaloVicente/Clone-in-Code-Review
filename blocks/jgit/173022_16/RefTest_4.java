	...
	public void testGetRefsExcludingPrefix() throws IOException {
		...
		List<Ref> refs =
				db.getRefDatabase().getRefsByPrefixWithSkips(RefDatabase.ALL
		assertEquals(13
	...
	public void testGetRefsExcludingPrefixes() throws IOException {
		...
		List<Ref> refs = db.getRefDatabase().getRefsByPrefixWithSkips(RefDatabase.ALL
		assertEquals(1
		checkContainsRef(refs
	}
	...
	public void testGetRefsWithPrefixExcludingPrefixes() throws IOException {
		...
		List<Ref> refs = db.getRefDatabase().getRefsByPrefixWithSkips(include
		assertEquals(1
		checkContainsRef(refs
	}
