...
public abstract class AbstractPath<FS extends FileSystem> implements Path
    ...
    public Path relativize(final Path otherx) throws IllegalArgumentException {
        ...
        if (isAbsolute() != other.isAbsolute()) {
            throw new IllegalArgumentException("Could not relativize path 'otherx'
        }
        ...
        if (i < other.getNameCount()) {
            ...
            subpath = other.getSeparator() == getSeparator() ? subpath : subpath.replaceAll(other.quoteSeparator()
            sb.append(subpath);
        }
