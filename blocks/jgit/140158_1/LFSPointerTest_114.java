...
public class AbbreviatedLongObjectIdTest {
	...
	public void testEmpty_FromByteArray() {
		...
		i = AbbreviatedLongObjectId.fromString(new byte[] {}
		assertNotNull(i);
		assertEquals(0
	...
	public void testFull_FromByteArray() {
		...
		assertNotNull(f);
		assertEquals(LongObjectId.fromString(s)
	...
	public void testFromStringByteWrongLength() {
		...
		try {
			AbbreviatedLongObjectId.fromString(buf
	...
	public void testPrefixCompareLong() {
		...
		a = new LongObjectId(0L
		assertEquals(-1
		a = new LongObjectId(1L
		assertEquals(-1
		a = new LongObjectId(1L
		assertEquals(-1
		a = new LongObjectId(1L
	...
	public void testGetFirstByte() {
		...
		assertEquals(0xf4
		assertEquals(id.getFirstByte()
	}

	@SuppressWarnings("unlikely-arg-type")
	@Test
	public void testNotEquals() {
		AbbreviatedLongObjectId a = new LongObjectId(1L
				.abbreviate(10);
