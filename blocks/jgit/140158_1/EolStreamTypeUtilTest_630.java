...
public class EolRepositoryTest extends RepositoryTestCase {
	...
	public void test_switchToBranchWithTextAttributes()
		...
		collectRepositoryState();
		assertEquals("binary -diff -merge -text"
		checkEntryContent(entryCRLF
		assertEquals("text"
		checkEntryContent(entryLF
		assertEquals("text"
	...
	protected RevCommit gitCommit(Git git
		return git.commit().setMessage(msg).call();
	}

	protected void gitAdd(Git git
	...
	protected void gitCheckout(Git git
			throws GitAPIException
