...
public class GitServlet extends MetaServlet {
	...
	private boolean getBoolean(String param) throws ServletException {
		...
		if (n == null)
			return false;
		else if (StringUtils.equalsIgnoreCase("yes"
				|| StringUtils.equalsIgnoreCase("true"
				|| StringUtils.equalsIgnoreCase("1"
				|| StringUtils.equalsIgnoreCase("on"
			return true;
		else if (StringUtils.equalsIgnoreCase("no"
				|| StringUtils.equalsIgnoreCase("false"
				|| StringUtils.equalsIgnoreCase("0"
				|| StringUtils.equalsIgnoreCase("off"
			return false;
		else
