...
public class Applier implements InCoreSupport {
      ...
      for (org.eclipse.jgit.patch.FileHeader fh : p.getFiles()) {
        ...
        switch (type) {
          ...
          case DELETE:
            ...
            ioHandler.addDeletion(fh.getOldPath()
            break;
          case RENAME:
            f = inCore ? null : getFile(fh.getOldPath()
  ...
  private void apply(String path
    ...
    try {
      ...
      if (PatchType.GIT_BINARY.equals(fh.getPatchType())) {
        ...
        RawText raw = ioHandler.getRawText(walk
            convertCrLf);
      ...
      if (resultStreamLoader != null) {
        ioHandler.update(resultStreamLoader
            safeWrite
      }
      if (hash != null) {
  ...
  private StreamLoader applyBinary(String path
    ...
    switch (hunk.getType()) {
      case LITERAL_DEFLATED:
        ...
        return ioHandler.getStreamLoader(() -> inflated
      case DELTA_DEFLATED:
        byte[] base;
        ...
        return ioHandler.getStreamLoader(() -> hashed
      default:
        throw new UnsupportedOperationException(
  ...
  private StreamLoader applyText(RawText rt
    ...
    try (OutputStream out = buffer) {
      ...
      return ioHandler.getStreamLoader(buffer::openInputStream
    }
  }
