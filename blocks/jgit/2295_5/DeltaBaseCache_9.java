...
public class ChunkMeta {
	public static ChunkMeta fromBytes(ChunkKey key
		...
		PARSE: for (;;) {
			...
			case 1:
				...
				baseChunk.add(BaseChunk.fromBytes(repo
				continue;
			case 2:
				if (fragment == null)
					fragment = new ArrayList<ChunkKey>(4);
				fragment.add(ChunkKey.fromShortBytes(repo
				continue;
			case 51:
				commit = PrefetchHint.fromBytes(repo
				continue;
			case 52:
				tree = PrefetchHint.fromBytes(repo
				continue;
			default:
				d.skip();
				continue;
	...
	public static class BaseChunk {
		...
		static BaseChunk fromBytes(RepositoryKey repo
			...
			PARSE: for (;;) {
				...
				case 1:
					...
					continue;
				case 2:
					chunk = ChunkKey.fromShortBytes(repo
					continue;
				default:
					d.skip();
					continue;
	...
	public static class PrefetchHint {
		...
		static PrefetchHint fromBytes(RepositoryKey repo
