...
public class EolRepositoryTest extends RepositoryTestCase {
	...
	@DataPoint
	public static String smallContents[] = { generateSmallTestData(true
			generateSmallTestData(false
			generateSmallTestData(true

	@DataPoint
	public static String hugeContents[] = { generateHugeTestData(true
			generateHugeTestData(false
			generateHugeTestData(true

	static String generateSmallTestData(boolean withCRLF
	...
	static String generateHugeTestData(boolean withCRLF
		StringBuilder sb = new StringBuilder();
