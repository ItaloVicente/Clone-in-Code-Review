...
public final class ChunkKey implements RowKey {
	...
	public static ChunkKey fromShortBytes(RepositoryKey repo
		return fromShortBytes(repo.asInt()
	}

	public static ChunkKey fromShortBytes(ObjectIndexKey obj
		return fromShortBytes(obj.getRepositoryId()
	}

	private static ChunkKey fromShortBytes(int repo
